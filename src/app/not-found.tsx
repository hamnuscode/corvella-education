...
export default function NotFound() {
  return (
    <section className="relative overflow-hidden bg-ink text-paper">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-20 top-0 h-[28rem] w-[28rem] rounded-full bg-iris/40 blur-[110px]"
      />
      <Container className="relative flex min-h-[72vh] flex-col items-center justify-center py-24 text-center">
        ...
        <p className="label mt-8 text-beacon">Error 404</p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            href="/"
            className="inline-flex h-[3.25rem] items-center justify-center gap-2 rounded-2xl bg-beacon px-7 font-semibold text-ink transition-transform duration-200 hover:-translate-y-0.5"
          >
            Back to home
